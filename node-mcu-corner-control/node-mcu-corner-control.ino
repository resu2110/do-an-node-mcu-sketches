...
const char* in_topic_temperature = "room/temperature-sensing-corner";
const char* in_topic_photon = "room/light-sensing-front-corner";
const char* in_topic_humidity = "room/humidity-sensing-corner";
...
const char* out_topic_lamp = "room/desk-lamp-corner-state";
const char* out_topic_mist_generator = "room/mist-generator-corner-state";
